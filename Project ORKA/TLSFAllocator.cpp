...
static void integrity_walker(void* ptr, size_t size, int used, void* user) {
	...
	auto integ = tlsf_cast(integrity_t*, user);
...
static void default_walker(void* ptr, size_t size, int used, void* user) {
	(void)user;
	printf("\t%p %s size: %x (%p)\n", ptr, used ? "used" : "free", static_cast<unsigned int>(size),
	       block_from_ptr(ptr));
}
...
void tlsf_walk_pool(pool_t pool, tlsf_walker walker, void* user) {
	...
	const block_header_t* block =
		offset_to_block(pool, -static_cast<int>(block_header_overhead));
...
void tlsf_remove_pool(tlsf_t tlsf, pool_t pool) {
	auto control = tlsf_cast(control_t*, tlsf);
...
pool_t tlsf_get_pool(tlsf_t tlsf) { return tlsf_cast(pool_t, static_cast<char*>(tlsf) + tlsf_size()); }
