...
//void Thing::generate() {
//	switch (type) {
//	case ThingType::SolarSystem: generateSolarSystem(*this); break;
//	case ThingType::Star: generateStar(*this); break;
//	case ThingType::Planet: generatePlanet(*this); break;
//	case ThingType::Moon: generateMoon(*this); break;
//	case ThingType::Continent: generateContinent(*this); break;
//	case ThingType::Lake: generateLake(*this); break;
//	case ThingType::Ocean: generateOcean(*this); break;
//	case ThingType::Island: generateIsland(*this); break;
//	default: logError("");
//	}
//}
//
//void Thing::render() {
//	switch (type) {
//	case ThingType::SolarSystem: renderSolarSystem(*this); break;
//	case ThingType::Star: renderStar(*this); break;
//	case ThingType::Planet: renderPlanet(*this); break;
//	case ThingType::Moon: renderMoon(*this); break;
//	case ThingType::Continent: renderContinent(*this); break;
//	case ThingType::Lake: renderLake(*this); break;
//	case ThingType::Ocean: renderOcean(*this); break;
//	case ThingType::Island: renderIsland(*this); break;
//	default: logError("");
//	}
//}
//
