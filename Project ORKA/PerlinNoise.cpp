...
Double PerlinNoise::Fade(const Double t) noexcept { return t * t * t * (t * (t * 6 - 15) + 10); }
Double PerlinNoise::noise(const Double x) const { return noise(x, 0.0, 0.0); }
PerlinNoise::PerlinNoise(const std::uint32_t seed) { reseed(seed); }
...
Double PerlinNoise::noise0_1(const Double x) const { return noise(x) * 0.5 + 0.5; }
Double PerlinNoise::noise(const Double x, const Double y) const { return noise(x, y, 0.0); }
Double PerlinNoise::Lerp(const Double t, const Double a, const Double b) noexcept { return a + t * (b - a); }
Double PerlinNoise::noise0_1(const Double x, const Double y) const { return noise(x, y) * 0.5 + 0.5; }
