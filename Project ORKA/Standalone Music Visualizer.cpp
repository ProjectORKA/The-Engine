...
//}
//
//class ORKAMusicVisualizer
//{
//	static constexpr bool fakeData         = false;
//	static constexpr int  sampleRate       = 48000;
//	static constexpr int  lowestFrequency  = 20;
//	static constexpr int  highestFrequency = 20000;
//	static constexpr int  bandCount        = 512;
//
//	unsigned long long currentSample = 0;
//
//	static constexpr int frameBufferSize = 1024;
//	int                  bufferOffset    = 0;
//	float                bufferA[frameBufferSize];
//	float                bufferB[frameBufferSize];
//	float*               frontBufferPtr = nullptr;
//	static float*               backBufferPtr  = nullptr;
//
//	void swapBuffers()
//	{
...
//	}
//
//	static void useBuffers(const unsigned int frameCount, const float* data)
//	{
...
//	}
//
//	static void callback(void* bufferData, const unsigned int unsignedFrameCount)
//	{
