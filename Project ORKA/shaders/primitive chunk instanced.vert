...
void main() {
	...
	vec3 worldPos = ((vertex + positions) + vec3(0.5,0.5,0.0) + worldOffset.xyz)/vec3(pow(2,worldOffset.w),pow(2,worldOffset.w),pow(2,worldOffset.w-1));
	...
	vertexColor = vec4(uvs,1.0f,1.0f);
