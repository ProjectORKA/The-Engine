...
void proceduralWireframeAxisLines(CpuMesh& cpuMesh) {
	...
	cpuMesh.textureCoordinates = Vector<Vec2>({
			Vec2(0.0f, 0.0f),
			Vec2(1.0f, 0.0f),
			Vec2(0.0f, 1.0f),
			Vec2(0.0f, 0.0f)
	...
	cpuMesh.vertexColors = Vector<Vec3>({
			Vec3(1.0f, 1.0f, 1.0f),
			Vec3(1.0f, 1.0f, 1.0f),
			Vec3(1.0f, 1.0f, 1.0f),
			Vec3(1.0f, 1.0f, 1.0f)
