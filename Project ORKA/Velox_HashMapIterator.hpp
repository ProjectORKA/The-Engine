...
public:
	...
	TemplatedIterator(BlockPointer entries, const usize index) noexcept
	...
	operator TemplatedIterator<HashMapType, const value_type>() const noexcept { return {current, index}; }
};
