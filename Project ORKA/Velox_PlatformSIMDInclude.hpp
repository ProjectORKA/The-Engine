...
#define SHUFFLE_PARAM(x, y, z, w) \
	...
	constexpr int32 ALIGN(16) _Sign_PNNP[4]   = { (int32) 0x00000000, (int32) 0x80000000, (int32) 0x80000000, (int32) 0x00000000 };
	const int32 ALIGN(16) __0FFF_[4]      = { (int32) 0xFFFFFFFF, (int32) 0xFFFFFFFF, (int32) 0xFFFFFFFF, (int32) 0x00000000 };
	...
	static FORCEINLINE __m128 _mm_highhalf_ps(__m128 dummy, __m128 vec) {
		...
		// Without AVX, we can save a MOVAPS with MOVHLPS into a dead register
		__m128 tmp = dummy;
		__m128 high = _mm_movehl_ps(tmp, vec);
		return high;
	#endif
	}
